...
namespace JardinConecta.Core.Interfaces
{
    public interface ICodigosDeInvitacionService
    {
        ...
        Task<CodigoInvitacionResult> GenerarCodigoInvitacionSala(Guid idJardin, Guid idSala, DateTime fechaExpiracion, TipoInvitacion tipoInvitacion, List<Guid>? idsInfante = null);
